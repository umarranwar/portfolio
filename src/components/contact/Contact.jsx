    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>umarr.anwar@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          <span>As Salhiyah, Riyadh, 12662</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
          <span>0531343915</span>
        </motion.div>
      </motion.div>
      <div className="formContainer">
        ...
        >
          <svg className="phone" width="380px" height="380px" viewBox="0 0 32.666 32.666">
            <motion.path
              strokeWidth={0.2}
        ...
        <span className="message" style={{ color: error ? "red" : "green" }}>
